...
const Shop = () => <div className="p-8">import React from 'react';
import { BrowserRouter as Router, Routes, Route } from 'react-router-dom';
...
// Composants temporaires (en attente de création des fichiers dédiés)
    ...
    <Router>
      <div className="flex min-h-screen bg-gray-950 text-gray-100 font-sans">
        ...
        <main className="flex-1 ml-64 min-h-screen relative overflow-hidden">
          {/* Image de fond avec contraste augmenté à 130% */}
          <div 
...
export default App;<h1 className="text-3xl font-bold text-white">Boutique</h1><p className="mt-4 text-gray-400">Page boutique en cours...</p></div>;
