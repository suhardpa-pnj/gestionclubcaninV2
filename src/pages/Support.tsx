      ...
      <form onSubmit={handleSubmit} className={`p-10 rounded-[40px] border space-y-8 ${darkMode ? 'bg-slate-900 border-slate-800' : 'bg-white border-emerald-50 shadow-xl'}`}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-2">Support utilisé</label>
            <select 
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-2">Page concernée</label>
            <select 
              value={formData.page}
