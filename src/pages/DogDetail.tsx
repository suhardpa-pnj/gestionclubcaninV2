...
const DogDetail: React.FC<DogDetailProps> = ({ dogId, onBack }) => {
  ...
  return (
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-700 pb-20">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div>
            ...
            <div className="flex items-center gap-4 mt-4">
              ...
              {/* AFFICHAGE DU SEXE AVEC ÉTAT NC */}
          ...
          <div className={`p-8 rounded-[40px] border-l-8 border-[#BC6C25] ${darkMode ? 'bg-slate-900 border-slate-800' : 'bg-white border-emerald-50 shadow-lg'}`}>
            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 flex items-center gap-2"><User size={14} /> Propriétaire</p>
      ...
      {/* MODALE D'ÉDITION AVEC OPTION VIDE PAR DÉFAUT */}
      {isEditModalOpen && formData && (
        <div className="fixed inset-0 z-[300] flex items-center justify-center p-4 bg-[#1B4332]/40 backdrop-blur-sm animate-in fade-in duration-300">
          <div className={`w-full max-w-xl rounded-[40px] shadow-2xl overflow-hidden border ${darkMode ? 'bg-slate-900 border-slate-800' : 'bg-white border-emerald-50'}`}>
            ...
            <form onSubmit={handleUpdate} className="p-8 space-y-4 max-h-[75vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-[9px] font-black uppercase text-slate-400 ml-2 tracking-widest">Section Club</label>
                ...
                <div className="space-y-1">
                  <label className="text-[9px] font-black uppercase text-slate-400 ml-2 tracking-widest">Niveau</label>
